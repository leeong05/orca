...
cols = range(4, 25)
dnames = ['total_cap', 'float_cap', 'high_52w', 'low_52w', 'PE', 'PB', 'PE_TTM', 'PB_TTM', 'POCF', 'POCF_TTM', 'PCF', 'PCF_TTM', 'PS', 'PS_TTM', 'turnover', 'free_turnover', 'total_shares', 'float_shares', 'PD', 'adj_high_52w', 'adj_low_52w']
