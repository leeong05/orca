...
# current liability
'shortterm_loan', 'impawned_loan', 'trading_liability', 'note_payable', 'account_payable', 'shortterm_bond_payable', 'advance_receipt', 'salary_payable', 'dividend_payable', 'tax_payable', 'interest_payable', 'other_payable', 'accrued_expense', 'deferred_proceed', 'noncurrent_liability_in_1y', 'other_current_liability', 'cl_exceptional_items', 'cl_adjustment_items', 'total_current_liability',
# non current liability
'longterm_loan', 'bond_payable', 'longterm_account_payable', 'specific_account_payable', 'estimate_liability', 'deferred_tax_liability', 'other_noncurrent_liability', 'ncl_exceptional_items', 'ncl_adjustment_liability', 'total_noncurrent_liability',
# financial liability
